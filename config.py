...
try:
    ...
    class Settings:  # type: ignore
        ...
        def __init__(self) -> None:
            ...
            # Advanced analysis
            self.adv_batch_size = 25
            self.adv_batch_timeout_sec = 45.0
            self.adv_max_tickers = 500
            self.adv_batch_concurrency = 6
            ...
            self.tadawul_market_enabled = True
