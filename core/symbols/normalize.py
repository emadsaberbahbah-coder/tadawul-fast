...
core/symbols/normalize.py
============================================================
Symbol Normalization — v1.2.1 (PROD SAFE / NO NETWORK)
...
# Hidden Unicode artifacts (zero-width marks, directionality, etc.)
...
def normalize_ksa_symbol(symbol: str) -> str:
    ...
    if s.endswith(".SR"):
        code = s[:-3]
        # ✅ FIX: removed walrus-in-ternary that broke compile on Render
