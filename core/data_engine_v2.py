...
"""
================================================================================
Data Engine V2 - GLOBAL-FIRST ORCHESTRATOR - v5.95.0
================================================================================
...
def _cs_body_wick_read(bars: List[Dict[str, float]]) -> Dict[str, Any]:
    ...
    half = max(2, (n + 1) // 2)
    if indecisive >= max(2, n // 2):
        sig = "INDECISIVE"
    elif decisive_up >= half and decisive_up > decisive_down:
        sig = "DECISIVE_UP"
