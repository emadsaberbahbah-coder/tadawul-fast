...
SCRIPTS: List[Tuple[str, str, str]] = [
    ...
    ("run_shadow_scorer", "1.4.0", "shadow scorer"),
    ("track_performance", "6.29.0", "track performance"),
    ...
    ("run_dashboard_sync", "6.28.0", "dashboard sync"),
