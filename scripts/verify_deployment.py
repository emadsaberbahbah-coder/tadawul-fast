...
MODULES: List[Tuple[str, str, str, str]] = [
    ...
    ("core.scoring", "__version__", "5.11.1", "scoring"),
    ("core.enriched_quote", "MODULE_VERSION", "4.10.0", "enriched quote"),
    ("core.analysis.opportunity_builder", "OPPORTUNITY_BUILDER_VERSION",
     "1.15.1", "opportunity builder"),
    ("core.analysis.portfolio_actions", "PORTFOLIO_ACTIONS_VERSION",
     "1.9.0", "portfolio actions"),
    ("routes.advanced_analysis", "ADVANCED_ANALYSIS_VERSION", "4.16.0",
     "advanced analysis route"),
    ("core.analysis.top10_selector", "TOP10_SELECTOR_VERSION", "4.29.0",
     "top10 selector"),
    ("core.providers.yahoo_chart_provider", "PROVIDER_VERSION", "8.13.0",
    ...
    ("core.data_engine_v2", "__version__", "5.133.0", "data engine"),
]
...
SCRIPTS: List[Tuple[str, str, str]] = [
    ...
    ("track_performance", "6.34.0", "track performance"),
    ...
    ("run_dashboard_sync", "6.46.0", "dashboard sync"),
