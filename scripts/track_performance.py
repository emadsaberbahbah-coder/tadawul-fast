...
===========================================================
TADAWUL FAST BRIDGE – ADVANCED PERFORMANCE ANALYTICS ENGINE (v6.0.0)
===========================================================
...
class PerformanceTrackerApp:
    ...
    def _analyze_performance(self, records: List[PerformanceRecord]) -> None:
        ...
        print("=" * 60)
        print(f"Total Records: {summary.total_records} | Win Rate: {summary.win_rate:.1f}%")
        print(f"Avg ROI: {summary.avg_roi:.2f}% | Sharpe Ratio: {summary.sharpe_ratio:.2f}")
