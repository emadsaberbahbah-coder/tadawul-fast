...
✅ Integrated symbols_reader logic for Arabic digits and invisible chars
...
# Enhanced header alias map with comprehensive coverage
_HEADER_ALIAS_MAP: Dict[str, str] = {
    ...
    "expectedreturn1m": "Expected ROI % (1M)",
    "expectedreturn3m": "Expected ROI % (3M)",
    "expectedreturn12m": "Expected ROI % (12M)",
    
    # Forecast price
    "forecastprice1m": "Forecast Price (1M)",
    "forecastprice3m": "Forecast Price (3M)",
    "forecastprice12m": "Forecast Price (12M)",
    "targetprice1m": "Forecast Price (1M)",
    "targetprice3m": "Forecast Price (3M)",
    "targetprice12m": "Forecast Price (12M)",
    
    # Forecast timestamps
    "forecastupdatedutc": "Forecast Updated (UTC)",
    "forecastupdatedriyadh": "Forecast Updated (Riyadh)",
    "forecastlastutc": "Forecast Updated (UTC)",
    "forecastasofutc": "Forecast Updated (UTC)",
...
def headers_from_dict_rows(rows: List[Dict[str, Any]]) -> List[str]:
    ...
    priority_keys = ["symbol", "ticker", "requestedsymbol", "name"]
    sorted_keys = []
    ...
    for key in sorted_keys:
        ...
        norm_header = _normalize_header_key(header)
...
if __name__ == "__main__":
    ...
    async def test_async():
        ...
        test_symbols = ["1120", "AAPL", "2222.SR", "MSFT", "TADAWUL:1120", "SA:4321", "٤٣٢١"]
        for sym in test_symbols:
            norm = _normalizer.normalize(sym)
            print(f"  {sym:15} -> {norm}")
        
        # Test market splitting
        ...
        test_dicts = [
            ...
            {"name": "Google", "value_score": 85, "momentum_badge": "GOOD"},
        ]
