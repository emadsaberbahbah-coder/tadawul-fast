...
class KsaIngestor:
    ...
    async def ingest(
        ...
        *,
        ...
        # Strict isolation: YAML must declare region=ksa
        ...
        # Persist snapshot (append-only), even if empty accepted (keeps audit trail)
        snapshot_payload = {
            "rows": accepted,
        ...
        return IngestionResult(
            ...
            errors=errors[:50],  # keep response small
        )
