...
def get_service_config(service_name: str) -> Optional[ServiceConfig]:
    ...
    try:
        config = asyncio.run(_config_manager.get_config())
        return config.get_service(service_name)
    except Exception:
        return None
...
def get_sama_config() -> Dict[str, Any]:
    ...
    try:
        ...
        return {
            ...
            "data_residency": config.sama.data_residency,
        }
    except Exception:
        return {
            "enabled": True,
            ...
            "audit_enabled": True,
            "retention_days": 90,
            "data_residency": ["sa-central-1", "sa-west-1"],
        }
...
def mask_settings_dict() -> Dict[str, Any]:
    ...
    try:
        ...
        masked = {
            ...
            "data_center": config.data_center.value,
            ...
            "compliance_standards": [c.value for c in config.compliance_standards],
        }
