...
Core Capabilities:
- Distributed configuration management (Consul, etcd, ZooKeeper, Redis, Kubernetes ConfigMaps)
            ...
            try:
                ...
                if azure_config.use_managed_identity:
                    ...
                    credential = ClientSecretCredential(
                        ...
                        client_id=azure_config.client_id.get_secret_value() if azure_config.client_id else None,
