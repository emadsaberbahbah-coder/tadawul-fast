...
- "quote_59": returns quote rows (sorted by opportunity score), using:
...
Compatibility:
- Engines may return list[quote] OR dict[symbol->quote] OR (payload, err) for batch calls.
- Quote objects may be dict-like or attribute objects.
"""
